...
type StorageLocInfo struct {
	...
	XAxes      string                `xorm:"nvarchar(100) 'x_axes'" json:"x_axes" smith:"verbose_name=X轴坐标,max=100"`
	YAxes      string                `xorm:"nvarchar(100) 'y_axes'" json:"y_axes" smith:"verbose_name=Y轴坐标,max=100"`
	Phone      core.NullString       `xorm:"nvarchar(100) 'phone'" json:"phone" smith:"verbose_name=电话,min=2,max=100"`
