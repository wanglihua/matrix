...
func (e EventPriority) ModelDesc() string {
	return "verbose_name=事件,entity_json=priority,route=event/priority"
}
...
type EquipmentType struct {
	...
	Code string `xorm:"nvarchar(50) notnull index unique 'type_code'" json:"type_code" smith:"verbose_name=编码,min=2,max=20"`
	Name string `xorm:"nvarchar(50) notnull index 'type_name'" json:"type_name" smith:"verbose_name=名称,min=2,max=20"`

	State core.NullString `xorm:"nvarchar(10) 'type_state'" json:"type_state" smith:"verbose_name=状态,max=10"`
...
func (e EquipmentType) ModelDesc() string {
	return "verbose_name=设备类型,entity_json=type,route=equipment/type"
}
